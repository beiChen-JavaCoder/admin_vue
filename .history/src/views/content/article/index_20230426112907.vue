<template>
  <div class="app-container">
    ...
    <el-tooltip class="item" effect="dark" content="选中文本复制" placement="top">
      <i class="el-icon-document-copy" style="cursor: pointer;" @click="copyText(props.row.name, true)"></i>
    </el-tooltip>
    <el-tooltip class="item" effect="dark" content="直接复制文本" placement="top">
      <i class="el-icon-copy" style="cursor: pointer; margin-left: 10px;" @click="copyText(props.row.name)"></i>
    </el-tooltip>
    <textarea ref="copyTextarea" style="opacity: 0; position: absolute; z-index: -1;"></textarea>
  </div>
          <el-form-item label="链接地址" style="display: block;" >
