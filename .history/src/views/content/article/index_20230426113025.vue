    ...
    <el-table-column type="expand" >
      <template slot-scope="props">
        <el-form label-position="left" inline class="demo-table-expand">
          ...
          <el-button type="text" size="mini" @click="copyText(props.row.name, true)">选中复制</el-button>
  <el-button type="text" size="mini" @click="copyText(props.row.name)">直接复制</el-button>
