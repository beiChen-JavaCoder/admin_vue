<template>
  <div class="app-container">
    ...
    <el-table-column label="biaoti " prop="propName">
  <template slot-scope="scope">
    <span v-if="scope.row.content.length > 20" class="preview-text"
          :title="scope.row.content">{{ scope.row.content.substring(0, 20) + '...' }}</span>
    <span v-else>{{ scope.row.content }}</span>
  </template
    <el-table-column
      label="摘要翻译"
      prop="snippet" width="auto" align="center">
    </el-table-column>
    <el-table-column
      label="收录时间"
      prop="time" width="auto" align="center">
    </el-table-column>
