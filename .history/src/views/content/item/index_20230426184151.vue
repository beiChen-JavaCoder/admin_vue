<template>
  ...
  <el-table-column label="ID" prop="id" :width="80" :min-width="80"></el-table-column>
  <el-table-column label="原文地址" prop="link" :min-width="300"></el-table-column>
  <el-table-column label="标题翻译" prop="title" :min-width="200"></el-table-column>
  <el-table-column label="摘要翻译" prop="snippet" :min-width="200"></el-table-column>
  <el-table-column label="收录时间" prop="time" :width="120" :min-width="120"></el-table-column>
</el-table>

      </template>
    </el-table-column>
    <el-table-column
      label="标题" width="auto" :min-width="25" :max-width="20" prop="title" align="center">
    </el-table-column>
    <el-table-column
      label="摘要翻译" prop="snippet" width="auto" align="center">
    </el-table-column>
    <el-table-column
      label="收录时间" prop="time" width="auto" align="center">
    </el-table-column>
