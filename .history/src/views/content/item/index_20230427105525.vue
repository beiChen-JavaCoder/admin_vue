<template>
  <div class="app-container">
      ...
      <el-col :span="24" :xs="24">
        <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          <el-form-item label="模糊搜索" prop="title">
            <el-input v-model="queryParams.title" placeholder="请输入关键字" clearable size="small" style="width: 240px"
    ...
    <el-table :data="tableData" border style="width: 100%" :expand-row-keys="expandedRows">
      ...
      <el-table-column label="收录时间" prop="time" width="auto" align="center">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleQuery(queryParams) {
      this.loading = true
      listIhandleQuerytem(this.queryParams).then((response) => {
        this.tableData = response.rows
        this.total = response.total
        this.loading = false
