<template>
  <div class="app-container">
      ...
      <el-col :span="24" :xs="24">
        <el-form v-show="showSearch" ref="queryForm" :model="queryParams" :inline="true" label-width="68px">
          <el-form-item label="模糊搜索" prop="keyword">
            <el-input v-model="queryParams.keyword" placeholder="请输入关键字" clearable size="small" style="width: 240px"
    ...
    <el-table :data="tableData" border style="width: 100%" :expand-row-keys="expandedRows">
      ...
      <el-table-column label="标题" width="auto" :min-width="25" :max-width="20" prop="title" align="center">
      </el-table-column>
      <el-table-column label="摘要翻译" prop="snippet" width="auto" align="center">
      </el-table-column>
      <el-table-column label="收录时间" prop="time" width="160" align="center">
      </el-table-column>
      <!-- <el-table-column label="操作" prop="link" width="80" align="center">
        <a href="https://www.baidu.com" target="_blank" style="color: blue;">查看</a>
      </el-table-column> -->
      <el-table-column label="操作" width="80" align="center">
        <template slot-scope="scope">
          <a :href="scope.row.link" style="color: blue;">查看</a>
        </template>
      </el-table-column>

    </el-table>
    <el-table>
  <el-table-column label="Title" :colspan="2"></el-table-column>
