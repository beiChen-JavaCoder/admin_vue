<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" border stripe style="width: 100%" :expand-row-keys="expandedRows">
      <el-table-column type="expand" style="white-space: normal;">
        <template slot-scope="props">
          <el-form label-position="left" inline class="demo-table-expand">
            <el-form-item label="ID" style="display: block;">
              <span>wwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwsssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss</span>
            </el-form-item>
            <hr>
