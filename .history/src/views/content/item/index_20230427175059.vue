<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" border stripe style="width: 100%" :expand-row-keys="expandedRows">
      ...
      <el-table-column label="标题" width="auto" prop="title" header-align="center" align="left" style="display: inline-block; white-space: nowrap;">
      </el-table-column>
      <el-table-column label="摘要翻译" prop="snippet" width="auto" header-align="center" align="left" style="display: inline-block; white-space: nowrap;">
      </el-table-column>
      <el-table-column label="收录时间" prop="time" width="160" align="center" style="display: inline-block; white-space: nowrap;">
      </el-table-column>
