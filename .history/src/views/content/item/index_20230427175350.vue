<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" border stripe style="width: 100%" height="200" :expand-row-keys="expandedRows">
      ...
      <el-table-column label="标题" width="auto" he prop="title" header-align="center" align="left">
      </el-table-column>
