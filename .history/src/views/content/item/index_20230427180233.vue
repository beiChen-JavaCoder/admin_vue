<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" border stripe style="width: 100%" :expand-row-keys="expandedRows">
      ...
      <el-table-column label="标题" width="auto" prop="title" header-align="center" align="left" @mouseenter="handleMouseEnter" mouseleave ="handleMouseLeave">
      </el-table-column>
...
export default {
  ...
  methods: {
    ...
    handleMouseEnter(){
      alert(移入),
      console.log('Mouse entered the column!');
    },
    handleMouseLeave(){
      alert(移出),
      console.log('Mouse entered the column!');
