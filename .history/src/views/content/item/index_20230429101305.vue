<template>
  <div class="app-container">
    ...
    <el-table :data="tableData" border="tru" stripe style="width: 100%" :expand-row-keys="expandedRows">
      ...
      <el-table-column label="标题" trigger="hover" width="auto" prop="title" header-align="center" align="left" >
      </el-table-column>
