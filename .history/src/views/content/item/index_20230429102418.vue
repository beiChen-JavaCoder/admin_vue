<template>
  <div class="app-container">
    ...
    :expand-row-keys="expandedRows">
      ...
      <el-table-column label="标题" width="aotu" height="200px" prop="title" header-align="center" align="left" >
      </el-table-column>
      <el-table-column label="摘要翻译" prop="snippet" width="80px" header-align="center" align="left">
      </el-table-column>
