    ...
    <el-dialog :title="title" :visible.sync="open" width="600px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-row>
          ...
          <el-col :span="18">
            <el-form-item v-if="form.id != undefined" label="更新用户密码" prop="password">
              <div style="display: flex;">
                <el-input v-model="form.password" placeholder="输入更新密码" type="password" maxlength="20" show-password
