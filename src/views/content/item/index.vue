<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="menuName" label="标题" :show-overflow-tooltip="true" width="160" />
      <el-table-column prop="icon" label="图标" align="center" width="100">
        <template slot-scope="scope">
          <svg-icon :icon-class="scope.row.icon" />
        </template>
      </el-table-column>
      <el-table-column prop="orderNum" label="摘要原文" width="100" />
      <el-table-column prop="perms" label="收录时间" :show-overflow-tooltip="true" />
